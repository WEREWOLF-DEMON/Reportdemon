...
def get_reason(text):
    if text == "Report child abuse":
        return InputReportReasonChildAbuse()
    elif text == "Report impersonation":
        return InputReportReasonFake()
    elif text == "Report copyrighted content":
        return InputReportReasonCopyright()
    elif text == "Report irrelevant geogroup":
        return InputReportReasonGeoIrrelevant()
    elif text == "Reason Pornography":
        return InputReportReasonPornography()
    elif text == "Report illegal durg":
        return InputReportReasonIllegalDrugs()
    elif text == "Report person detail":
        return InputReportReasonSpam()
    elif text == "Report spam":
        return InputReportReasonPersonalDetails()
    elif text == "Report Violence":
    ...
    # resportreason = input("whats ur pepoet reason: ")
     ...
     for account in config["accounts"]:
        ...
        async with Client(name="Session", session_string=string) as app:
            try:
                #await app.get_chat(-1002043989551)
